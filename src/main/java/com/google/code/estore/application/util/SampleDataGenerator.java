...
public class SampleDataGenerator implements ServletContextListener {
	...
	public void loadSampleData() {
		...
		Product p6 = ProductFactory.createProduct("ASUS K43EI245SA-SL","i5-2450M 4G 500G HD6","ASUSK43EI245SA-SL.jpg",5300,4299,"20120101").save();
		Product p7 = ProductFactory.createProduct("Acer AS4749-32352G50","i3-2350M 2G 500G ","AcerAS4749-32352G50.jpg",4500,3099,"20120102").save();
		...
		Product p11 = ProductFactory.createProduct("Canon Power Shot G1 X","1430万像素 3.0可旋转液晶屏 4倍","PowerShotG1X.jpg",5400,4999,"20120101").save();
		...
		Order o1 = OrderFactory.getOrderBuilder().withOrderDate("20120101").withTotalMoney(1000)
				.withOderItem(p1, 1).withOderItem(p2, 2).build();
		Order o2 = OrderFactory.getOrderBuilder().withOrderDate("20120102").withTotalMoney(2000)
				.withOderItem(p1, 3).withOderItem(p2, 4).build();
		...
		Order o4 = OrderFactory.getOrderBuilder().withOrderDate("20120104").withTotalMoney(2000)
				.withOderItem(p13, 1).withOderItem(p14, 1).build();
